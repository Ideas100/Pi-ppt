...
frame2.subtitle('Subtitle: right', font='Courier', side='right')
...
frame3.subtitle('Subtitle: left', font_color='grey35', side='left')
...
"""
frame5.title(title)
frame5.subtitle(subtitle, side='right', justify='right')
